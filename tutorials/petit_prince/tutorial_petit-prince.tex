...
\begin{figure}[h]
\includegraphics[width=8cm]{figures/pendulum.png}\includegraphics[width=8cm]{figures/icecube.png}
\caption{Left: the geometry of a pendulum. Right: a floating ice cube. }
\end{figure}
